...
`python main_vis.py --config cfgs/pretrain/multitask_cbc.yaml --exp_name uw_ch1_train_cls_4096_32_64_wbc \
--ckpts experiments/multitask_cbc/pretrain/uw_ch1_train_cls_4096_32_64_wbc/ckpt-last.pth --test`